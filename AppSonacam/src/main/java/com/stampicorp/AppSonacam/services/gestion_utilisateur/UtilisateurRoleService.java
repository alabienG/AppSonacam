...
public class UtilisateurRoleService {
    ...
    public List<UtilisateurRole> listByUtilisateur(Long idUser) {
        return utilisateurRoleRepo.findByUtilisateurAndEtatEquals(new Utilisateur(idUser), Constantes.ADD);
    }
}
