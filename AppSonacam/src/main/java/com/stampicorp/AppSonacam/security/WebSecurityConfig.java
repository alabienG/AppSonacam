package com.stampicorp.AppSonacam.security;
...
import com.stampicorp.AppSonacam.services.secutity.UserDetailsServiceImpl;
...
//        authenticationManagerBuilder.userDetailsService(userDetailsService).passwordEncoder(passwordEncoder());
        authenticationManagerBuilder.userDetailsService(new UserDetailsService() {
            ...
            public UserDetails loadUserByUsername(String s) throws UsernameNotFoundException {
                Utilisateur user = userRepository.findByUsername(s)
